...
/** 描述 CFB 复合文档数据块的头部信息。 */
type CfbHeader = {
  /** CfbHeader 从源格式读取的 majorVersion 枚举或标识值。 */
  majorVersion: number;
  /** CfbHeader 使用的目标字节数。 */
  sectorSize: number;
  /** CfbHeader 对应项目的数量。 */
...
/** 读取 `readUint16` 所需的源数据，供CFB 复合文档解析使用。 */
function readUint16(view: DataView, offset: number) {
  return view.getUint16(offset, true);
}

/** 读取 `readUint32` 所需的源数据，供CFB 复合文档解析使用。 */
function readUint32(view: DataView, offset: number) {
  return view.getUint32(offset, true);
}

/** 执行 `padPartialFinalSector` 封装的CFB 复合文档解析处理步骤。 */
...
/** 执行 `validateSectorIndex` 封装的CFB 复合文档解析处理步骤。 */
...
/** 解析 `parseHeader` 接收的数据，并返回CFB 复合文档解析结果。 */
...
/** 执行 `concatChunks` 封装的CFB 复合文档解析处理步骤。 */
...
/** 读取 `readDifat` 所需的源数据，供CFB 复合文档解析使用。 */
...
/** 读取 `readFat` 所需的源数据，供CFB 复合文档解析使用。 */
...
/** 读取 `readSectorChain` 所需的源数据，供CFB 复合文档解析使用。 */
...
/** 执行 `objectTypeFromValue` 封装的CFB 复合文档解析处理步骤。 */
...
/** 解析 `parseDirectoryEntries` 接收的数据，并返回CFB 复合文档解析结果。 */
...
/** 执行 `assignDirectoryPaths` 封装的CFB 复合文档解析处理步骤。 */
...
/** 读取 `readMiniFat` 所需的源数据，供CFB 复合文档解析使用。 */
...
/** 读取 `readMiniSectorChain` 所需的源数据，供CFB 复合文档解析使用。 */
...
/** 创建 `createCfbFile` 返回的对象，供CFB 复合文档解析使用。 */
