...
export function calculatePositionStyle(position: DocxPosition | undefined) {
  ...
  if (relativeFromH === 'page') {
    ...
    calculatedLeft = `calc(${safePx(
      safeLeft,
    )} - var(--office-file-docx-page-margin-left, 0px))`;
    ...
    // 相对于右边距：从页面右边缘开始
    calculatedLeft = `calc(var(--office-file-docx-page-width, 100%) - var(--office-file-docx-page-margin-right, 0px) + ${safePx(
      safeLeft,
    )} - var(--office-file-docx-page-margin-left, 0px))`;
  ...
  if (relativeFromV === 'page') {
    ...
    calculatedTop = `calc(${safePx(
      safeTop,
    )} - var(--office-file-docx-page-margin-top, 0px))`;
    ...
    calculatedTop = `calc(var(--office-file-docx-page-margin-top, 0px) + ${safePx(
      safeTop,
    )})`;
    ...
    // 相对于下边距：从页面底部开始
    calculatedTop = `calc(var(--office-file-docx-page-height, 100%) - var(--office-file-docx-page-margin-bottom, 0px) + ${safePx(
      safeTop,
    )} - var(--office-file-docx-page-margin-top, 0px))`;
